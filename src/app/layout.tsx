...
export const metadata: Metadata = {
  title: "Monaco Luxury Cars - Premium Exotic Vehicles",
  description: "Discover exclusive luxury supercars and exotic vehicles in Monaco. Experience premium automotive excellence with our curated collection.",
  keywords: "luxury cars Monaco, exotic vehicles, supercars, Ferrari, Mercedes, Lamborghini, premium automobiles",
  metadataBase: new URL("https://monacocluxury.mc"),
  alternates: {
    canonical: "https://monacocluxury.mc"
  },
  openGraph: {
    title: "Monaco Luxury Cars - Premium Exotic Vehicles",
    description: "Discover exclusive luxury supercars and exotic vehicles in Monaco. Experience premium automotive excellence.",
    type: "website",
    siteName: "Monaco Luxury Cars",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SARPpOYHFbiqus5iP5yOitJp2/uploaded-1763914193103-t2rl5oog.png",
  ...
  twitter: {
    ...
    title: "Monaco Luxury Cars - Premium Exotic Vehicles",
    description: "Exclusive luxury supercars and exotic vehicles in Monaco",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SARPpOYHFbiqus5iP5yOitJp2/uploaded-1763914193103-t2rl5oog.png"]
  },
  robots: {
    index: true,
    follow: true
